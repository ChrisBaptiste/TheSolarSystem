...
//   solarSystem[2].diameter = "7962 miles";
...
solarSystem.forEach(planet => {
  ...
  console.log("venus eccentricti is " + system.venus.eccentricity)
  
  // 3. Console.log the sum of the number of satellites of Jupiter, Saturn, Uranus, and Neptune (131)
  let jupiterSatellites = Number(system.jupiter.satellites);
  let saturnSatelites = system.saturn.satellites;
  let uranusSatellites = system.uranus.satellites;
  let neptuneSatellites = system.neptune.satellites;
  let totalSatellites = jupiterSatellites + saturnSatelites + uranusSatellites + neptuneSatellites;
  ...
  if(typeof system.mercury.radiusp === "sting"){
  ...
  console.log(system.mercury.radiusp); // this is confusing it still prints out "same" to console.
